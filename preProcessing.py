...
class GroundTruthCorre():
    def __init__(self, imageName, focalLength, rotationMatrix, cameraCenter, distortion):
...
def main():
    ...
    for lineCount, line in enumerate(gt.readlines()):
        ...
        if lineCount <= 1:
            ...
            groundTruthList.append(GroundTruthCorre(imageName, focalLength,
                                                    rotationMatrix, cameraCenter, distortion))
